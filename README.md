...
## 非常抱歉哈，本处的hosts为了让你有个更好的体验，各类网址都是非常全的，（条目完整性排行是github全网第二，ipv4 hosts第一，第一家是github上的ipv6hosts那个）从而可以做到秒开各类网站或者youtube视频的效果，如果你因为设备所限制，不想使用完整的服务，仅仅是需要部分服务的话，请前往wiki页面找到几个备用的更新源来选择合适的版本 **
