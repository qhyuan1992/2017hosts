...
**不欢迎任何政治过于极端的人来这里提问题，如果你是这样的情况最好请你找我私下商量，以避免被网友认出来网友们骂你**
...
#### 非常抱歉哈，本处的hosts为了让你有个更好的体验，各类网址都是非常全的，hosts文件很大，系统读取可能会比较慢（条目完整性是github全网第排二，ipv4 hosts第一，第一家是github上的ipv6hosts那个，截至发本篇说明前是这样的）从而可以做到秒开各类网站或者youtube视频的效果，如果你因为设备所限制，不想使用完整的服务，仅仅是需要部分服务的话，请前往wiki页面找到几个备用的更新源来选择合适的版本 
